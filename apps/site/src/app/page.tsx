      ...
      <Section className="fill black">
        <div className="split2">
          ...
          <div className="wait flex left">
            ...
            <Space block h="32" />
            <Text color="gray">
              Hosted nearly every week during the academic quarter, you'll get
              the chance to level up your design game and make new friends with
              fellow designers.
            </Text>
            <Space block h="32" />
            <Link href="/events/">
        ...
        <div className="split2">
          ...
          <div className="wait flex left">
            ...
            <Space block h="32" />
            <Text className="color gray ">
              Meet other designers, get exclusive perks, and expand your
              portfolio with fresh new work.
            </Text>
            <Space block h="32" />
            <Link href="/resources/">
              <Text icon="right" color="blue">
          ...
          <Section className="center bare relative">
            <div className="flex spaceChildren">
              <Text className="wait scale bold narrow color white" size="XL">
                We're focused on buliding a friendly community that helps
                striving designers.
              </Text>
              <Link href="/about/">
